...
const ChatbotForm = ({
  ...
  const parsedOrigins = useMemo(
    () => parseList(formData.allowed_origins_text),
  ...
  const colorInputClass =
    "h-11 w-full rounded-2xl border border-white/10 bg-white/[0.04] p-1";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-[#04070fcc] px-4 py-8 backdrop-blur-sm">
      <div className="shell-modal my-8 flex max-h-[calc(100vh-4rem)] w-full max-w-5xl flex-col overflow-hidden rounded-[28px]">
        <div className="flex items-start justify-between border-b border-white/8 px-6 py-5">
          <div>
            <p className="text-[0.78rem] uppercase tracking-[0.28em] text-white/50">
              Chatbot Workspace
            </p>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className={helperTextClass}>
                    List each approved website origin on its own line.
                  </p>
                </div>
            ...
            {step === 5 && (
              <div className="shell-info-panel space-y-3 text-sm text-white/76">
                ...
                <div>
                  <span className="font-medium text-white">Launcher:</span>{" "}
              ...
              <div className="flex gap-3">
                {canGoNext ? (
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-2xl bg-[#2f66ea] px-4 py-3 text-sm font-semibold text-black transition hover:bg-[#295ad0]"
                  >
                    Next
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-black transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {loading
                      ? "Saving..."
                      : chatbot
