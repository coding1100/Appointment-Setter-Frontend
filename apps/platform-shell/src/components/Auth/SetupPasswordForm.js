      ...
      <div className="flex flex-1 items-center justify-center px-4">
        ...
        >
          <div className="rounded-3xl border border-gray-100 bg-white shadow-2xl p-10">
            <h2 className="text-center text-3xl font-semibold text-gray-900">Set your password</h2>
            <p className="mt-2 text-center text-sm text-gray-500">Complete account setup to continue.</p>
