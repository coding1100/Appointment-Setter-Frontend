  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-[0.78rem] uppercase tracking-[0.32em] text-slate-500">Operations Overview</p>
          <h1 className="mt-3 text-[2rem] font-semibold tracking-[-0.03em] text-slate-900">Operations Dashboard</h1>
      ...
      {error && (
        <div className="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <span>{error}</span>
            <button onClick={fetchDashboardData} className="text-left text-sm font-semibold text-rose-700 underline">
              Retry
            </button>
          </div>
        </div>
